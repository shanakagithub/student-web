...
/**
     ...
     *
     * @preserve
     */signIn(t,l,i,n){var d;return e(this,void 0,void 0,(function*(){if(yield this._isInitialized(),F.canContinueSignIn(Boolean(null==t?void 0:t.callOnlyOnRedirect),l))return null==t||delete t.callOnlyOnRedirect,null===(d=this._client)||void 0===d?void 0:d.signIn(t,l,i,n).then((e=>(this._onSignInCallback&&(e.allowedScopes||e.displayName||e.email||e.username)&&this._onSignInCallback(e),e)))}))}trySignInSilently(t){var l;return e(this,void 0,void 0,(function*(){if(yield this._isInitialized(),!F.wasSignInCalled())return null===(l=this._client)||void 0===l?void 0:l.trySignInSilently(t).then((e=>{if(this._onSignInCallback&&e){const t=e;(t.allowedScopes||t.displayName||t.email||t.username)&&this._onSignInCallback(t)}return e}))}))}
/**
